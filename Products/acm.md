...
<table>
  ...
  <tr>
    ...
    <td> <!--  資料  -->
      <a href="
        https://content.redhat.com/us/en/assets/display.html?id=41b985a3-8a5d-45c9-bca4-76b5e6805cd2
      " target="_blank" rel="noreferrer noopener">
        <!--  タイトル  -->
        PDF
      </a>
...
<table>
  ...
  <tr>
    ...
    <td><!--  概要  -->
      Red Hat Advanced Cluster Management for Kubernetes 2.11でサポートされる管理対象クラスタとHubのサポート環境を示します。
    </td>
    <td><!--  対象バージョン  -->
      Version 2.11
    </td>
    <td>　<!--  資料  -->
      <a href="
        https://access.redhat.com/articles/7073065
      " target="_blank" rel="noreferrer noopener">
        <!--  タイトル  -->
        Link
      </a>
